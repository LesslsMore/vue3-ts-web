...
async function exportNeodbList() {
    ...
    for (let i in types) {
        ...
        let data = await fetchData(token.value, "", type, timeout);

        const endTime = new Date().getTime();

        console.log(`${data.wishlist.length} (wishlist), ${data.progress.length} (progress),${data.complete.length} (complete) ${type} loaded in ${endTime - startTime} ms`);
...
:root {
    ...
    --btn-color: #fff;
    --btn-bg: #45b787;
    --text-bg-hover: rgba(69, 183, 135, 0.7);
    --light-grey: #eee;
    --dark-grey: #cacaca;
    --white: #fff;
    --text-highlight-color: #1f2d3d;
    --blockquote-color: #6a737d;
    --blockquote-bg: rgba(69, 183, 135, 0.1);
    --reward-pop: #f5f5f5;
    ...
    --scrollbar-color: #45b787;
    --default-bg-color: #45b787;
    --zoom-bg: #fff;
...
#article-container .timeline {
    ...
    border-left: 2px solid var(--timeline-color, #45b787);
}
...
#article-container .timeline .timeline-item:hover .item-circle:before {
    border-color: var(--timeline-color, #45b787);
}
...
#article-container .timeline .timeline-item.headline .timeline-item-title .item-circle:before {
    left: -28px;
    border: 4px solid var(--timeline-color, #45b787);
}
...
#article-container .timeline .timeline-item .timeline-item-content {
    ...
    padding: 12px 15px;
    border-radius: 8px;
    background: var(--timeline-bg, #e3f4ed);
    font-size: 0.93em;
}
